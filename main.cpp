 ...
 * - Minesweeper
 * Description: This program is a version of minesweeper that lets you put the number of rows and columns
 * and lets you play like the orginal game with reviling tiles and capturing flags.
 * 
 *
 * Developers:
 * - Chris Mayak - mayakcn@mail.uc.edu
 * - Will Granlund - granluwm@mail.uc.edu
 *
 * Help Received:
 * - Instructor Ade
 * 
 ...
 * Developer 1:
 * I learned a lot and this gave me some great practice with loops arrays vectors and functions.
 * Developer 2:
 * This gave me some great practice and learned how to look at code and see what to change and how.
 */
...
void Board::inputChoices() {// Checks for valid entry
	...
	cin >> mines;
	while (cout << "Verify the number of mines(max " << rows * rows - 1 << "): " && !(cin >> mines) || (mines > rows*rows - 1) || (mines < 1)) {
		cout << "Not a valid input. Try again." << endl;
		cin.clear(); // reset failbit
		cin.ignore(numeric_limits<streamsize>::max(), '\n');
	}
